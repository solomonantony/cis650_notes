movie_data = [
    ...
    {   'id': 11, 'title': "Mary Poppins", 'tagline': "It's supercalifragilisticexpial'id'ocious!",
    ...
    {   'id': 95, 'title': "Mulholland Drive", 'tagline': "An actress longing to be a star. A woman searching for herself. Both worlds will coll'id'e... on Mulholland Drive",
